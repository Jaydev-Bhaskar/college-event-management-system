              ...
              {requests.length === 0 ? (
                ...
                <div style={{ overflow: 'auto' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.65rem 1rem', borderTop: '1px solid var(--border)' }}>
                    <span style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>Showing {pendingRequests.length} of {requests.length} applications</span>
                    <div style={{ display: 'flex', gap: '0.25rem' }}>
                      <button className="btn btn-ghost btn-sm">‹</button>
                      <button className="btn btn-primary btn-sm" style={{ minWidth: 28 }}>1</button>
